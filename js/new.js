window.onload = () => {
    ...
    var hideObtainChildsContainer = function () {
        gsap.to(".obtain-childs-container i.icon--placeholder-back", {
            opacity: 0,
            delay: 0.3,
            duration: 1.5,
        });
        ...
        gsap.to(".obtain-childs-container .side-content", {
            opacity: 0,
            height: 0,
            delay: 1.2,
            duration: 1.5,
...
$("#ManagedService").on("click", () => {
    ...
    gsap.to("#obtainChildFirst i.icon--placeholder-back", {
        opacity: 1,
        delay: 1.3,
        duration: 1.5,
    });
    ...
    gsap.to("#obtainChildFirst .side-content", {
        opacity: 1,
        height: "100%",
        delay: 2.2,
        duration: 1.5,
...
$("#Software").on("click", () => {
    ...
    gsap.to("#obtainChildSecond i.icon--placeholder-back", {
        opacity: 1,
        delay: 1.3,
        duration: 1.5,
    });
    ...
    gsap.to("#obtainChildSecond .side-content", {
        opacity: 1,
        height: "100%",
        delay: 2.2,
        duration: 1.5,
...
$("#Hybrid").on("click", () => {
    ...
    gsap.to("#obtainChildThird i.icon--placeholder-back", {
        opacity: 1,
        delay: 1.3,
        duration: 1.5,
    });
    ...
    gsap.to("#obtainChildThird .side-content", {
        opacity: 1,
        height: "100%",
        delay: 2.2,
        duration: 1.5,
